...
class Solution:
    ...
    # BFS, wrong answer
    def findAllPeopleWrong(self, n: int, meetings: List[List[int]], firstPerson: int) -> List[int]:
        ...
        for p1,p2,time in meetings:
            ...
            if p2 not in graph:
                graph[p2] = []
            graph[p1].append((time, p2))
            graph[p2].append((time, p1))
